...
export const BACKGROUND_URL = "https://assets.nflxext.com/ffe/siteui/vlv3/e8136cfe-c5b7-464f-8c26-d68d676e0916/web/IN-en-20251229-TRIFECTA-perspective_c50c689c-0d42-413b-bd09-f4fc62fbec13_large.jpg";

export const OPTION_API = {
  method: 'GET',
  headers: {
    accept: 'application/json',
    Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0MmQyZmQ5NmQ2Y2U4MzFkMGMxOGRmMDlmMzAxMmY4YSIsIm5iZiI6MTc2OTI1ODQzMi4zMDIsInN1YiI6IjY5NzRiZGMwZWVmMjhhZjRhZGVhZWIxMyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.8izkVZT4OM4Y6s-QzC8S2qAh62149YGTAhJUgSc2_GA'
  }
};
